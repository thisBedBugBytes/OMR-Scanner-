...
pdf = PDF('P', 'mm', 'A4') #portrait, measured in millimetre
...
# Get the user input
user_input = input("Enter number of questions: ")
...
rows_per_page = q_no(pdf.p_y)  # Max rows per page
...
for i in range(question_no):
    ...
    # Increment row counter and decrement question_counter
    current_row += 1
    question_counter -= 1
