...
from .models import Attendance, Examination, Subject
...
def get_attendance(request):
    ...
    try:
        ...
        attendance = Attendance.objects.filter(subject=subject, examination=examination)
        attendance_list = []
        for attd in attendance:
            data = {
                    "id": attd.id,
                    "attendance_date": str(attd.date),
                    "examination": attd.examination.id
                    }
