...
class Examination(models.Model):
    ...
    def __str__(self):
        return "From " + str(self.exam_date) + " to " + str(self.exam_time)


class CustomUser(AbstractUser):
    USER_TYPE = ((1, "Chair"), (2, "Teacher"), (3, "Student"))
...
class Student(models.Model):
    ...
    examination = models.ManyToManyField(Examination, related_name='students')
...
class Feedback(models.Model):
    # Use GenericForeignKey to allow feedback to be linked to either a student or a teacher
    sender_student = models.ForeignKey('Student', null=True, blank=True, on_delete=models.CASCADE)
    #sender_teacher = models.ForeignKey(Teacher, null=True, blank=True, on_delete=models.CASCADE)
    #receiver_student = models.ForeignKey(Student, null=True, blank=True, related_name='received_feedbacks', on_delete=models.CASCADE)
    receiver_teacher = models.ForeignKey('Teacher', null=True, blank=True, related_name='received_feedbacks', on_delete=models.CASCADE)
...
class StudentResult(models.Model):
    ...
    marksheet_pic = models.ImageField()
