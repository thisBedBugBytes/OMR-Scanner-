...
urlpatterns = [
    ...
    path("add_examination/", hod_views.add_examination, name='add_examination'),
    ...
    path("examination/manage/", hod_views.manage_examination, name='manage_examination'),
    path("examination/edit/<int:examination_id>",
         hod_views.edit_examination, name='edit_examination'),
    ...
    path("examination/delete/<int:examination_id>",
         hod_views.delete_examination, name='delete_examination'),
