...
def add_examination(request):
    ...
    if request.method == 'POST':
        if form.is_valid():
            ...
            messages.error(request, 'Fill Form Properly ')
    return render(request, "hod_template/add_examination_template.html", context)


def manage_examination(request):
    examinations = Examination.objects.all()
    context = {'examinations': examinations, 'page_title': 'Manage Examinations'}
    return render(request, "hod_template/manage_examination.html", context)
    ...
    if request.method == 'POST':
        if form.is_valid():
            try:
                ...
                return render(request, "hod_template/edit_examination_template.html", context)
        else:
