...
class _SideMenuWidgetState extends State<SideMenuWidget> {
  ...
  final Color selectionColor = const Color(0xFF8A8A8A); // You can change this color
  ...
  Widget buildMenuEntry(SideMenuData data, int index) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        color: isSelected ? selectionColor : Colors.transparent, // Use the defined selection color
      ),
      child: InkWell(
        onTap: () => setState(() {
          selectedIndex = index;
